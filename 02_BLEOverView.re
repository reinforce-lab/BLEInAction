...
技術に直接関わっていなくても、Bluetooth Low Energy技術の理解は必要です。それは、無線通信の専門家の理解ではなく、振る舞いを考え出したりアイディアを議論に必要な理解です。また技術を担当するからといって、この技術を詳細まで理解しようとする必要はありません。自分が担当する領域で、この技術を適切に扱い設計判断を誰かに説明できる知識と理解とが必要です。

まず、数ある無線通信技術を特徴や利用場面で分類をして、Bluetooth Low Energy技術がどのような領域に適した技術なのかを見ていきます。そして、この技術で生み出される振る舞いを、その振る舞いを支える技術要素に分解して、利用場面を成り立たせている技術の理解を深めます。

そして、Bluetooth Low Energy技術を俯瞰していきます。この技術には、超低消費電力無線通信技術やGATT基盤プロファイルなど、この技術の特徴を表す特有の用語がいくつも登場します。それぞれの用語がどのようなものなのかを、通信の流れの中で位置付けながら理解していきます。
