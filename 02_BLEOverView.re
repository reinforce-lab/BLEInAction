= Bluetooth Low Energy技術 とはなんだろう


無線通信規格、電波、データ表現、普及しているかどうか。どれほど優れていても、それが特殊すぎては、1社が。
無線通信規格、形のないもの。規格、相手がいること、特定の1つとつながる、規格に適合していれば接続して使える。
Bluetooth Low Energy技術は、ものとものとがおしゃべりするような無線通信技術と言えます。

無線通信技術、全体からの使い道。チームの中での役割、パーツとしてみたときのものを見てきた。
無線通信規格というものを選ぶとして、どんなものがあるのか、適切なのか、他の規格と比べてどうなのか。
概要。



これまで、役割は何か、具体的に何を目指すのか、あるいはその変遷とを見てきた。BLEを選択しているのは、おそらく常に、世界に広く普及したスマートホンという通信相手、そしてアプリケーション次第でサービス展開ができること。
教育分野、誰が考えても同じことになるならば、プログラミングの能力で、自動化して仕舞えばいい。逆に、そこにいつまでも人という資源を使っているようでは。今、水田の田植えに人手を使わないように。
そしてフィットネスをはじめとして、スマートホンを軸にしたスマートホンだけでは提供不可能な利用場面が、普及してそういうものがあると認識されている、つまり市場があるから。

チーム、自分の役割を抑えて、全体像をイメージ。その中で、末端の何かと、スマートホン、それぞれのハードとソフト、サービスとしての形。既存のビーコン利用の場合はサービス利用だけど、必要ならハードウェアを自前で。あるいはロボットとかでのインタラクション活用とか。例えば、接近したことを検出する強力な手段として、ピンポイント。意外と、活用の場面は広い上に、何かしら通信の相手側を用意する、それはハードウェアが絡む。ソフトだけなら、エンジニアがカバーしてくれるだろうけど、未知の分野。些細でつまらないことでも、手がけたことがないものは、負荷が重い上に、ちょっとした部分の提供に手が取られる。

== 無線通信規格の役割
通信には必ず通信相手が必要。通信相手とは同じ通信の知識を共有していなければならない。
物理層とリンク、そしてデータ表現。ルールであって、形あるものではない。形あるものである場合は、両端をハードウェア提供している場合が多い。
