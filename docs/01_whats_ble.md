...
Bluetooth Low Energy を活用する製品群は、アプリケーション(Application)とアクセサリ(Accessory)を組み合わせた アプセサリ(Appcessory = App + cessory) という造語で呼ばれます。この造語は、スマートフォンのアプリケーションやネットワーク・サービスと連携することで、従来のアクセサリではありえなかった、新しい魅力が生まれることを表現しています。

ですから、無線通信技術としての Bluetooth Low Energy だけを見ていては、アプセサリは生み出せません。ハードウェアとアプリケーションそしてネットワーク・サービスの3つを、ユーザの体験に織り上げていかねばなりません。

この章は、Bluetooth Low Energy を、技術とその使い方の2つの視点で見ていきます。また、技術とそのユーザ体験は変化し続けていくものですから、今後の時代の流れを考える材料として、ここ3年間のアプセサリの実例とその変遷も見ていきます。
