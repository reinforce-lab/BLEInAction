...
#define EVENT_GENERIC_RX2_DONE (EVENT_GENERIC_BASE+EVENT_GENERIC_OFFSET+4)//YTS
...
typedef struct _GENERIC_DEVICE
{
    ...
    union
    {
        ...
        struct
        {
            ...
            BYTE rx1Busy         : 1;    // Driver busy receiving data YTS
            BYTE rx2Busy         : 1;    // Driver busy receiving data YTS
            #ifdef USB_GENERIC_SUPPORT_SERIAL_NUMBERS
