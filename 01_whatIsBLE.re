...
Bluetooth Low Energy技術 は、ものとものとがおしゃべりをするような無線通信技術と言えます。では、ものとものとのおしゃべりとは、どのようなもので、また、おしゃべりするものを作ったり活用するには、どうすればできるのでしょうか。これに答えるのが本書の目的です。

技術に目がいくと、技術を理解すれば全てを解決できそうな気がして、Bluetooth Low Energy技術を隅から隅まで理解したくなるかもしれませんが、それは違います。無線通信規格は、世界にある様々なものがお互いにおしゃべりをするための共通基盤、つまり部品にすぎません。ですから、まず最初におこなうべきは、この無線通信規格を部品として、何に用いるか、どのように活用するかを明らかにすることです。
...
難しさ、分量が多いだけ、本質的に基礎学習が必要、やり方を覚えればいいだけ、計算式を解く様に基礎を学び特定の問題に当たればいいけど解き方は知っていればできるだけ、問題設定から始めないといけないもの。
