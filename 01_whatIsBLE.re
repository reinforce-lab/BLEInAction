...
Bluetooth Low Energy技術 は、ものとものとがおしゃべりをするような無線通信技術と言えます。そのおしゃべりは、どのようなもので、どうすれば作れるものなのでしょうか。

#@# 自分の目的をはっきりと、無線というものはお約束、実現技術の基礎知識、環境、チーム、アイディア出し
Bluetooth Low Energy技術に興味があり、それを知りたいと思うでしょう。ですが、その知りたいことというのは、人により、あるいは状況や環境そして目的により、大きく異なります。まずはこの章で、Bluetooth Low Energy技術を活用したいと思う動機や、手に入れたいと思っている結果を明らかにしましょう。
...
次に、Bluetooth Low Energy技術の活用場面をみていくことで、このものとものとがおしゃべりする技術が、どのように活用できるのかを理解していきます。おしゃべりは単独ではできません。通信には必ず通信相手が必要です。いくつかの場面をみていくことで、これから自分達が作る何かが、1対1でおしゃべりをするものなのか、すでにあるおしゃべりの場に参加したいのかが、わかるようになるでしょう。
...
スマートホン、その通信とソフトウェアの構成。一般周辺機器、アプセサリ(GATT)。
インターネットプロトコルとは無線なもの。つまり電波が直接届く範囲での利用場面。工夫すればいけるかもだけど。
多様性とデバイスの広い普及。なんでもできるよという特性。接続数の無制限さや、接続の多様性、ペアリングがなくてもいいJust workなど。セキュリティが必要な場面とか、指定。
その上で、利用場面とかもっと広く見ていこうか。
...
この活用している場面を思い浮かべながら、先ほどの表に書き入れていきます。場所の項目には、自分が何かを作っている場所や活用している場所を書きます。目的や結果の項目には、完成させたものや活用している何かや手に入れた何かなどを、思いつくままに書き並べていきます。最後に、動機の項目に、自分がどのような気持ちや望みで作ったり活用しているのか、自分をかき立てるものを書き並べます。

この表は、自分を自分で客観的に見つめるためのもので、誰かに見せたりするものではありませんから、自分にわかりさえすれば、どのように書いてもよいものです。文章で書いてもよいですし、絵を描くのもよいでしょう。何も思い浮かばない、わからないならば、わからないとだけ書いておけばよいのです。あるいは、そのわからなさから感じるモヤモヤした感じを、ぐちゃぐちゃとした線の塊で表現しておくのもいいです。
...
場所の項目には、作っている場所であれば自宅や学校あるいは会社が、活用している場所であれば、生活の場としての自宅や人が活動したり集まる場所としての学校や会社あるいは駅や空港が並ぶかもしれません。目的や結果の項目は、まさに多種多様でしょう。例えば、スマートホンから操作するラジコンカーのような具体的なものがあるかもしれません。あるいは、プログラミング学習や、プログラムを作り動かす技能の習得があるかもしれません。形があるものではなく、これまでにない新たなサービスや事業のような、大きな目的があるかもしれません。
...
また会社で組織の一員として、技術的な部分を担当するかもしれません。検討段階で実験をするために試作品を作ったり、あるいは量産するための製品の設計を担当するかもしれません。その動機は、組織の中での役割を果たすことです。

Bluetooth Low Energy技術との関わり方を明らかにしたところで、次は、代表的な場合を詳しく見ていきましょう。
...
受信側から逆に見た電波の経路は、たいてい複数あります。送信側から受信側が直接見える位置にあったとします。真空中と同じく、送信側と受信側を一直線に結ぶ反射も減衰も受けない最短の経路が、もっとも強く電波が届く経路です。そして、周りにある大地や鉄筋コンクリートの��物では床や壁そして天井で反射されて届く経路があります。何かに反射して届く経路は、最短経路よりも少し長い距離を伝搬してきています。電波の波は正負に振動していますから、経路が波長ずれていると波の振幅がちょうど同じ符号で強めあい、経路が波長の半分ずれいていると波の振幅が正と負で打ち消しあい弱めあう関係になります。
